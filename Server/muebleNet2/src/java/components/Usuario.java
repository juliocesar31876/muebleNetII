...
//        session.getBasicRemote().sendText(data.toString());
    ...
    private void editarPerfil(JSONObject data, Session session) throws JSONException, SQLException {
        ...
        usuario.put("key", datat.getString("key"));
        usuario.put("telefono", datat.getString("telefono"));
        con.update("usuario", new JSONArray().put(usuario));

        JSONObject persona = new JSONObject();
        persona.put("key", datat.getString("key_persona"));
        persona.put("nombres", datat.getString("nombres"));
        persona.put("apellidos", datat.getString("apellidos"));
        persona.put("correo", datat.getString("correo"));
        persona.put("fecha_nacimiento", datat.getString("fecha_nacimiento"));
        con.update("persona", new JSONArray().put(persona));
